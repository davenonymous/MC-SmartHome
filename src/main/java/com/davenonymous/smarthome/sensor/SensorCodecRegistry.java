...
public class SensorCodecRegistry {
	...
	public static final Registry<MapCodec<? extends SensorSettings>> SENSOR_SETTINGS_SERIALIZERS = new RegistryBuilder<>(SensorCodecRegistry.SENSOR_SETTINGS_SERIALIZERS_KEY).create();
	public static final DeferredRegister<MapCodec<? extends SensorSettings>> DEFERRED_SENSOR_SETTINGS = DeferredRegister.create(SensorCodecRegistry.SENSOR_SETTINGS_SERIALIZERS, SmartHome.MODID);
	...
	public static final Registry<StreamCodec<? super RegistryFriendlyByteBuf, ? extends SensorSettings>> SENSOR_SETTINGS_DISPATCHER = new RegistryBuilder<>(SensorCodecRegistry.SENSOR_SETTINGS_DISPATCHER_KEY).sync(true).create();
	public static final DeferredRegister<StreamCodec<? super RegistryFriendlyByteBuf, ? extends SensorSettings>> DEFERRED_SENSOR_SETTINGS_DISPATCHER = DeferredRegister.create(SensorCodecRegistry.SENSOR_SETTINGS_DISPATCHER, SmartHome.MODID);
	...
	static void newRegistry(NewRegistryEvent event) {
		event.register(SensorCodecRegistry.SENSOR_SETTINGS_SERIALIZERS);
		event.register(SensorCodecRegistry.SENSOR_SETTINGS_DISPATCHER);
	}
