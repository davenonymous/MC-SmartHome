package com.davenonymous.smarthome.util.client;
...
public class OverlayLineRenderType extends RenderType {
	...
	private static CompositeState createComposite(LineStateShard lineState) {
	...
	private static RenderType createRenderType(int thickness, LineStateShard lineStateShard) {
		return create("overlay_lines_"+thickness+"_smarthome",
