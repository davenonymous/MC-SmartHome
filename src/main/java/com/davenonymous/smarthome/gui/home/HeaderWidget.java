...
public class HeaderWidget extends WidgetHBox {
	...
	public HeaderWidget() {
		...
		this.titleText = new WidgetTextBox("The quick brown fox plays monkey island all day long and is extremely tired");//I18n.get("smarthome.gui.home.title"));
